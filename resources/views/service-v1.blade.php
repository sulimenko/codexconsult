	...
	<div class="container">
		...
		<div class="wrapper">
			<div class="row">
				...
				@foreach([
					['image' => '10.jpg', 'details' => 'Регистрация юридического лица' ],
					['image' => '16.jpg', 'details' => 'Подбор видов деятельности (ОКЭД)' ],
					['image' => '3.jpg', 'details' => 'Получение лицензий в МФЦА' ],
					['image' => '8.jpg', 'details' => 'Разработка учредительных документов' ],
					['image' => '5.jpg', 'details' => 'Получение свидетельства налогоплательщика' ],
					['image' => '6.jpg', 'details' => 'Оформление электронно‐цифровой подписи (ЭЦП)' ],
					['image' => '7.jpg', 'details' => 'Услуга номинального директора (при регистрации)' ],
					] AS $each)
