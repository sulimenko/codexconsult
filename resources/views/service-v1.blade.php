	...
	<div class="container">
		...
		<div class="wrapper">
			<div class="row">
				...
				@foreach([
					['image' => '1.jpg', 'details' => 'Разработка учредительных документов' ],
					['image' => '2.jpg', 'details' => 'Регистрация юридического лица' ],
					['image' => '3.jpg', 'details' => 'Получение Лицензий в МФЦА' ],
					['image' => '4.jpg', 'details' => 'Подбор видов деятельности (ОКЭД)' ],
					['image' => '5.jpg', 'details' => 'Получение регистрационного свидетельства налогоплательщика (БИН/ИИН)' ],
					['image' => '6.jpg', 'details' => 'Оформление электронно‐цифровой подписи (ЭЦП)' ],
					['image' => '7.jpg', 'details' => 'Услуга номинального Директора при регистрации в МФЦА' ],
					] AS $each)
