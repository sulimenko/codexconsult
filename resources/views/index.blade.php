...
<body>
	<div class="main-page-wrapper">
					...
					<div class="address-wrapper float-right">
						<ul>
							<li class="address">
								...
								<h6>Адрес:</h6>
								<p>Астана, пр. Мангилик Ел 55/21, 120 офис</p>
							</li>
							<li class="address">
							...
							<li class="quotes"><a href="index.html#">Задать вопрос</a></li>
						</ul>
					</div> <!-- /.address-wrapper -->
				</div> <!-- /.container -->
			</div> <!-- /.top-header -->
							...
							<nav id="mega-menu-holder" class="clearfix">
								<ul class="clearfix">
									<li class="active"><a href="index.html#">Главная</a>
										<ul class="dropdown">
											<!-- <li><a href="index.html">Главная версия 1</a></li> -->
											<!-- <li><a href="index-2.html">Главная версия 2</a></li> -->
										</ul>
									</li>
									<li><a href="index.html#">Компания</a>
										<ul class="dropdown">
											<li><a href="about.html">О нас</a></li>
											<li><a href="team.html">Наша Команда</a></li>
											<!-- <li><a href="faq.html">Faq's</a></li> -->
											<li><a href="shop.html">Документы</a></li>
											<li><a href="404.html">Реквизиты</a></li>
											<!-- <li><a href="shop-details.html">Shop details</a></li> -->
											<!-- <li><a href="index.html#">Third Level menu</a> -->
											<ul>
												<!-- <li><a href="index.html#">Demo one</a></li> -->
												<!-- <li><a href="index.html#">Demo two</a></li> -->
											</ul>
									</li>
								</ul>
								</li>
								<li><a href="index.html#">Услуги</a>
									<ul class="dropdown">
										<li><a href="service.html">Релокация в Казахстан</a></li>
										<li><a href="service.html">Команда под ключ</a></li>
										<li><a href="service.html">Аутсорсинг задач</a></li>
										<!-- <li><a href="service-v2.html">Service version two</a></li> -->
										<li><a href="service-details.html">Пост услуги</a></li>
									</ul>
								</li>
								...
								<li><a href="index.html#">Пресс центр</a>
									<ul class="dropdown">
										<li><a href="blog.html">Новости МФЦА</a></li>
										<li><a href="blog-grid.html">Новости Компании</a></li>
										<li><a href="blog-details.html">Вопросы-Ответы АФСА</a></li>
									</ul>
								</li>
						...
						<div class="right-widget float-right">
							<ul>
								<li class="social-icon">
									<ul>
										<li><a href="index.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
										</li>
										<li><a href="index.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
										</li>
										<li><a href="index.html#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
										</li>
										<li><a href="index.html#"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
										</li>
									</ul>
								</li>
								<li class="cart-icon">
									<a href="index.html#"><i class="flaticon-tool"></i> <span>2</span></a>
								</li>
								<li class="search-option">
									<div class="dropdown">
										<button type="button" class="dropdown-toggle" data-toggle="dropdown"><i
												class="fa fa-search" aria-hidden="true"></i></button>
										<form action="index.html#" class="dropdown-menu">
		...
		<div class="about-compnay section-spacing">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-12"><img src="images/home/111.jpg" alt=""></div>
		...
		<div class="service-style-one section-spacing">
			<div class="container">
				<div class="theme-title-one">
					<h2>Услуги</h2>
					<p>Наша команда специализируется на предоставлении следующих услуг:</p>
				</div> <!-- /.theme-title-one -->
				<div class="wrapper">
					<div class="row">
		...
		<div class="our-team section-spacing">
			<div class="container">
				<div class="theme-title-one">
					<h2>Команда</h2>
					<p>Профессиональный коллектив является важнейшим капиталом Нашей компании
					</p>
				</div> <!-- /.theme-title-one -->
				<div class="wrapper">
					<div class="row">
...
<!--						<div class="col-lg-3 col-sm-6 col-12">
		...
		<div class="theme-counter section-spacing">
			<div class="container">
				<div class="bg">
					<h6>Основная статистика</h6>
					<h2>достижения МФЦА к началу 2022 года </h2>

					<div class="cunter-wrapper">
						<div class="row">
							<div class="col-md-3 col-6">
								<div class="single-counter-box">
									<div class="number"><span class="timer" data-from="0" data-to="1173" data-speed="1200"
							...
							<div class="col-md-3 col-6">
								<div class="single-counter-box">
									<div class="number"><span class="timer" data-from="0" data-to="89"
											data-speed="1200" data-refresh-interval="5">0</span>%</div>
									<p>Рост регистрации за последний год</p>
								</div> <!-- /.single-counter-box -->
							</div> <!-- /.col- -->
							<div class="col-md-3 col-6">
								<div class="single-counter-box">
				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-12">
						<div class="partner-slider">
							<div class="item"><img src="images/logo/p-6.png" alt=""></div>
							<div class="item"><img src="images/logo/p-6.png" alt=""></div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-sm-6 about-widget">
							<h6 class="title">КОНСУЛЬТАЦИЯ</h6>
							<p>Вы решили выбрать нашу Компанию для решения сложных задачь, но остались вопросы. Позвоните, и мы обязательно
								сможем найти ответы.</p>
							<div class="queries"><i class="flaticon-phone-call"></i> Остались вопросы: <a
									href="index.html#">+7 727 346  9025, +7 707 350 7550</a></div>
						</div> <!-- /.about-widget -->
						<div class="col-xl-4 col-lg-3 col-sm-6 footer-recent-post">
							<h6 class="title">ПУБЛИКАЦИИ</h6>
							<ul>
								<li class="clearfix">
						...
						<div class="col-xl-3 col-lg-2 col-sm-6 footer-newsletter">
							...
							<form action="index.html#">
								...
								<button class="theme-button-one">Подписаться</button>
							</form>
						</div>
					</div> <!-- /.row -->
				</div> <!-- /.container -->
